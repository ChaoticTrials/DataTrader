...
public class ModItems {
    ...
    public static final Item traderSpawnEgg = new ForgeSpawnEggItem(() -> ModEntities.dataTrader, 0x5E5450, 0xBD8B72, new Item.Properties()) {
        ...
        public void appendHoverText(@Nonnull ItemStack stack, @Nullable Level level, @Nonnull List<Component> components, @Nonnull TooltipFlag flag) {
            components.add(Component.translatable("tooltip.datatrader.legacy").withStyle(ChatFormatting.RED));
    ...
    public static final Item newTraderSpawnEgg = new ForgeSpawnEggItem(() -> ModEntities.newDataTrader, 0xEF6231, 0xBD8B72, new Item.Properties()) {
